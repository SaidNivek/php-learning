...
echo strpos($string, 'o'); // psoition 4

// Find the position of the last occurrence of a substring in a string
echo strrpos($string, 'o'); // position 7
...
// String replace
// Replace a substring, passing the thing you want to replace, the string to replace it with, and the string itself
